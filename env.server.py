...
"""
TOPICS = {
    'json': 'one_dollar_breath/testjson',
    'url': 'one_dollar_breath/testurl',
    'get_url': 'one_dollar_breath/testgeturl',
    'image': 'one_dollar_breath/testimage',
    'error': 'one_dollar_breath/error',
}
BANNER = "[TEST][SERVER]"
MQTT_BROKER = 'one-dollar-breath.cloud.shiftr.io', 1883
CREDENTIALS = 'one-dollar-breath', 'public'
METADATA_DOMAIN = 'test.api.breath4.sale'
DOMAIN = "test.art.breath4.sale"
COLLECTION = "PH_8747"
